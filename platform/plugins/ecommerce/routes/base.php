...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'product-recurring-option', 'as' => 'product-recurring-option.'], function () {
            Route::resource('', 'ProductRecurringOptionController')
                ->parameters(['' => 'product_recurring-option']);
                
                Route::delete('items/destroy', [
                    'as' => 'deletes',
                    'uses' => 'ProductRecurringOptionController@deletes',
                    'permission' => 'product_recurring-option.destroy',
                ]);
    
                Route::get('search', [
                    'as' => 'search',
                    'uses' => 'ProductRecurringOptionController@getSearch',
                    'permission' => 'product_recurring-option.index',
                ]);
            });
