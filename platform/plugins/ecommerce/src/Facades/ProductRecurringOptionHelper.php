...
use Botble\Ecommerce\Supports\ProductRecurringOptionHelper as BaseProductRecurringOptionHelper;
 ...
 *
 * @see \Botble\Ecommerce\Supports\ProductRecurringOptionHelper
 */
class ProductRecurringOptionHelper extends Facade
{
    protected static function getFacadeAccessor(): string
    {
        return BaseProductRecurringOptionHelper::class;
    }
}
