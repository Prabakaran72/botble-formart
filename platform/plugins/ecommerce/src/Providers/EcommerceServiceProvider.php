...
use Botble\Ecommerce\Facades\ProductRecurringOptionHelper;
...
use Botble\Ecommerce\Models\ProductRecurringOption;
...
use Botble\Ecommerce\Repositories\Caches\ProductRecurringOptionCacheDecorator;
...
use Botble\Ecommerce\Repositories\Eloquent\ProductRecurringOptionRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ProductRecurringOptionInterface::class, function () {
            return new ProductRecurringOptionCacheDecorator(
                new ProductCategoryRepository(new ProductCategory())
            );
        });
        ...
        $loader->alias('ProductRecurringOptionHelper', ProductCategoryHelper::class);
    ...
    public function boot(): void
    {
        ...
        SlugHelper::registerModule(ProductCategory::class, 'Product Recurring Option');
        ...
        SlugHelper::setPrefix(ProductCategory::class, 'product-recurring-option');
        ...
        $this->app['events']->listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    'id' => 'cms-plugins-product-recurring-option',
                    'priority' => 5,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::product-recurring-option.name',
                    'icon' => 'fa-solid fa-repeat',
                    'url' => route('product-recurring-option.index'),
                    'permissions' => ['product-recurring-option.index'],
                ])
                ->registerItem([
        ...
        $this->app['events']->listen(['cart.removed', 'cart.stored', 'cart.restored', 'cart.updated'], function ($cart) {
        ...
        //         \CustomField::registerModule(Ecommerce::class)
        //             ->registerRule('basic', __('Ecommerce'), Ecommerce::class, function () {
        //                 return $this->app->make(EcommerceInterface::class)->pluck('name', 'id');
        //             })
        //             ->expandRule('other', 'Model', 'model_name', function () {
        //                 return [
        //                     Ecommerce::class => __('Ecommerce'),
        //                 ];
        //             });
        //     }
        // });
