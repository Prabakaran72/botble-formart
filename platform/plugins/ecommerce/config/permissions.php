...
return [
   ...
   /**
     ...
     */
    [
        'name' => 'Product recurring option',
        'flag' => 'product-recurring-option.index',
        'parent_flag' => 'plugins.ecommerce',
    ],
    [
        'name' => 'Create',
        'flag' => 'product-recurring-option.create',
        'parent_flag' => 'product-recurring-option.index',
    ],
    [
        'name' => 'Edit',
        'flag' => 'product-recurring-option.edit',
        'parent_flag' => 'product-recurring-option.index',
    ],
    [
        'name' => 'Delete',
        'flag' => 'product-recurring-option.destroy',
        'parent_flag' => 'product-recurring-option.index',
    ],
